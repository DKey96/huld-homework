"""
Django settings for huld project.
...
SECRET_KEY = "django-insecure-k+cz0nmp(0_55j6h1n*qaiw326$j=p8hh%jeq4%^lnz9%6%!y_"
...
WSGI_APPLICATION = "huld.wsgi.application"
...
# Folder path, from which the files shall be sent
